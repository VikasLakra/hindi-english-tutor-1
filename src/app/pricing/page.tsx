      ...
      <div className="mx-auto max-w-5xl">
        ...
        <section className="mt-14 grid gap-5 md:grid-cols-[1.15fr_.85fr]">
          <div className="border border-border bg-foreground p-7 text-background sm:p-9">
            ...
            <div className="mt-9">{user ? <SubscribeButton /> : <Link href="/auth/start" className="inline-flex h-9 items-center gap-2 bg-primary px-4 text-sm font-bold text-primary-foreground">Sign in to subscribe <span>↗</span></Link>}<p className="mt-3 text-xs text-background/45">$1 per month. Cancel anytime. Secure checkout handled by Stripe.</p></div>
          </div>
